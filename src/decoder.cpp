...
DecoderStatus Decoder::DecodeRegular(uint32_t data, DecodedInstruction& instruction, DecodedOperand* operands) const {
    ...
    switch (opcode) {
        ...
        case 0b1010111: {
            #define CHECK_OPIVV(mnemonic) do { if (funct3 == 0b000) return DecodeRType<Mnemonic::mnemonic, Extension::V, ArchFeature::RV64, Vector, Vector, Vector>(instruction, operands, info); } while(0)
            #define CHECK_OPFVV(mnemonic) do { if (funct3 == 0b001) return DecodeRType<Mnemonic::mnemonic, Extension::V, ArchFeature::RV64, Vector, Vector, Vector>(instruction, operands, info); } while(0)
            #define CHECK_OPMVV(mnemonic) do { if (funct3 == 0b010) return DecodeRType<Mnemonic::mnemonic, Extension::V, ArchFeature::RV64, Vector, Vector, Vector>(instruction, operands, info); } while(0)
            #define CHECK_OPIVI(mnemonic) do { if (funct3 == 0b011) return DecodeVIType<Mnemonic::mnemonic, Extension::V, ArchFeature::RV64>(instruction, operands, info); } while(0)
            #define CHECK_OPIVX(mnemonic) do { if (funct3 == 0b100) return DecodeRType<Mnemonic::mnemonic, Extension::V, ArchFeature::RV64, Vector, GPR0, Vector>(instruction, operands, info); } while(0)
            #define CHECK_OPFVF(mnemonic) do { if (funct3 == 0b101) return DecodeRType<Mnemonic::mnemonic, Extension::V, ArchFeature::RV64, Vector, FPR64, Vector>(instruction, operands, info); } while(0)
            #define CHECK_OPMVX(mnemonic) do { if (funct3 == 0b110) return DecodeRType<Mnemonic::mnemonic, Extension::V, ArchFeature::RV64, Vector, GPR0, Vector>(instruction, operands, info); } while(0)
